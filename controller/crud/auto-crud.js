...
app.get("/admin/auto-crud/:pathName", async (req, res) => {
  ...
  try {
    ...
    res.render("admin/auto-crud/index", data);
  } catch (error) {
 ...
 */
app.get("/admin/auto-crud/:pathName/create", async (req, res) => {
  try {
    // obtener parámetros
    const { pathName } = req.params;
    const actionForm = `/admin/auto-crud/${pathName}`;
    ...
    res.render("admin/auto-crud/create", data);
  } catch (error) {
 ...
 */
app.post("/admin/auto-crud/:pathName", async (req, res) => {
  try {
    // obtener parámetros
    const { pathName } = req.params;
    ...
    res.redirect(`/admin/auto-crud/${pathName}`);
  } catch (error) {
 ...
 */
app.get("/admin/auto-crud/:pathName/update/:id", async (req, res) => {
  try {
    // obtener parámetros
    const { pathName, id } = req.params;
    const actionForm = `/admin/auto-crud/${pathName}/${id}`;
    ...
    if (!objDb) return res.redirect(`/admin/auto-crud/${pathName}`);
    ...
    res.render("admin/auto-crud/update", data);
  } catch (error) {
    console.log("Se ha presentado un error - GET - create");
    console.log(`BH-ERROR: ${error}`);
    res.redirect("/admin");
 ...
 */
app.post("/admin/auto-crud/:pathName/:id", async (req, res) => {
  try {
    // obtener parámetros
 ...
 */
app.get("/admin/auto-crud/:pathName/delete/:id", async (req, res) => {
  try {
    // obtener parámetros
    const { pathName, id } = req.params;
